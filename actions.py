...
class MeleeAction(ActionWithDirection):
    def perform(self, engine: Engine, entity: Entity) -> None:
        ...
        target = engine.game_map.get_blocking_entity_at_location(destination_x, destination_y)
        if not target:
            return
...
class MovementAction(ActionWithDirection):
    ...
    def perform(self, engine: Engine, entity: Entity) -> None:
        ...
        if engine.game_map.get_blocking_entity_at_location(destination_x, destination_y):
            return
